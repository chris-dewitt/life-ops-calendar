...
EVENTS_URL = "https://www.ganttcenter.org/events/"
VENUE = "Harvey B. Gantt Center, 551 S Tryon St, Charlotte NC"


class GanttCenterScraper(BaseScraper):
    SOURCE = "Harvey B. Gantt Center"
    ...
    def scrape(self) -> list[dict]:
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                # Tribe Events Calendar (most common WP plugin) + generic fallbacks
                selectors = (
                    ".tribe-events-calendar-list__event-article, "
                    ".tribe-events-calendar-list__event, "
                    "article.tribe_events_cat, article.tribe-event, "
                    ".evcal_eventcard, "
