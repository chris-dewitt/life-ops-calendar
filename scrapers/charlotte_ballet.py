...
EVENTS_URL = "https://www.charlotteballet.org/performances"
VENUE = "Charlotte Ballet, Belk Theater, Charlotte NC"


class CharlotteBalletScraper(BaseScraper):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                selectors = (
                    ...
                    ".performance-card, .show-card, "
                    "article[class*='performance'], article[class*='event'], "
                    "li[class*='performance'], li[class*='event']"
                )
